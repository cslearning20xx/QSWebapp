...
with st.sidebar.form(key='BaselineInputs'):
    ...
    noclaimdiscounts = st.multiselect( "Choose no claim discount", ['None', '10%@5%', '20%@10%','2%@50%',], ['None'], help = "%discount@%policies, 20%@10% implies 20% discount for 10% of policies" )
