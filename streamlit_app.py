...
with st.sidebar.form(key='BaselineInputs'):
    ...
    higherpremiumgearingrange = st.slider('Gearing Range for higher premium', min_value = 1, max_value = 5, value = (2.0, 2.5))
    lowerpremiumgearingrange = st.slider('Gearing Range for lower premium', min_value = 1, max_value = 5, value = (1.5, 1.0) )
